...
- **Los 28 skills de Owoslawski están instalados en `.claude/skills/`** (github.com/growthenginenowoslawski/coldoutboundskills, vendorizados tal cual). Conviven con los `gtm-*` así:
